...
using GrpcOrganization.Services;
...
builder.Services.AddDbContext<GrpcDbContext>(item => item.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
